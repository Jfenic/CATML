...
TASK_CATALOG: dict[TaskType, dict] = {
    TaskType.BINARY_CLASSIFICATION: {
        ...
        "metrics": ["roc_auc", "accuracy", "f1", "churn_cost", "f_beta"],
        "model_ids": ["logistic_regression", "random_forest", "svc", "lightgbm", "xgboost", "voting_ensemble"],
    },
    TaskType.MULTICLASS_CLASSIFICATION: {
        "label": "Clasificación multiclase",
        "description": "Predecir una entre tres o más clases discretas.",
        "default_metric": "accuracy",
        "metrics": ["accuracy", "f1", "roc_auc", "f_beta"],
        "model_ids": ["logistic_regression", "random_forest", "svc", "lightgbm", "xgboost", "voting_ensemble"],
    },
    TaskType.REGRESSION: {
        "label": "Regresión",
        ...
        "default_metric": "r2",
        "metrics": ["r2", "mae", "rmse"],
        "model_ids": ["ridge", "random_forest", "svr", "lightgbm", "xgboost", "voting_ensemble"],
    },
    TaskType.CLUSTERING: {
